...
SimpleAddonManagerDB = {
	...
	["autoProfile"] = {
		["Qpfromage-LivingFlame"] = {
			["playerId"] = "Qpfromage-LivingFlame",
			...
			["addons"] = {
				...
				["FojjiCore"] = true,
				["Leatrix_Plus"] = true,
				["BlizzMovePlugin_QuestTracker"] = true,
				["Masque_Fusion"] = true,
				...
				["WeakAuras"] = true,
				["BetterBags_Tabards"] = true,
				["Questie"] = true,
				["Talented_Data"] = true,
				["Masque_Squarish"] = true,
				["Postal"] = true,
				["TacoTip"] = true,
				["LogoutSkips"] = true,
				["ExtendedCharacterStats"] = true,
				["BugSack"] = true,
				...
				["BiS-Tooltip-SoD"] = true,
				["Sheepi_UI"] = true,
				["SharedMedia"] = true,
				["Details_DataStorage"] = true,
				["Bagnon_Config"] = true,
				["BetterBags_Legendary"] = true,
				["Talented"] = true,
				["Masque_Serenity"] = true,
				["WeakAurasArchive"] = true,
				["Bartender4"] = true,
				["SimpleAddonManager"] = true,
				["ElvUI_RatioMinimapAuras"] = true,
				["BlizzMove"] = true,
				["OmniCC_Config"] = true,
