...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Experience Bar - Luxthos"] = {
			...
			["information"] = {
				["forceEvents"] = true,
				["saved"] = "JrXkQ4ulU4mZpVYskNelUKicGJf(LlvuQjMti5xcqImZnvjyUz1Ak9eZmVutjIaymOCtSIicqcgTEbtQ4ssSOsaPcnsJTWAbSM8j1YsfSM4WSPvGOGmqqYhqojwzQPeuQfwAQfxcyfd4",
			},
			["icon_side"] = "LEFT",
			["sparkColor"] = {
				1, -- [1]
