...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Experience Bar - Luxthos"] = {
			...
			["information"] = {
				["forceEvents"] = true,
				["saved"] = "JrXkQ4ulU4mZpVYskNelUKicGdb4(sfLAI5es(LaKiZCtvcwIx4MspXmZl1uIiagdk3eRiIaKGjh0zsfxsIfvcivOrAkNywG1KpPwwQG1ehwuAbIcYabjFa5KyLPMsqPwyPPwCjGuC2a(d",
			},
			["overlays"] = {
				{
					1, -- [1]
