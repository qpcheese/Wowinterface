...
do
	...
	list[#list+1] = {text = GetFaction(2564),	func = SetIgnoreFilter,	arg1 = "faction2564IgnoreFilter",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2564) and DF() end	}
	list[#list+1] = {text = GetFaction(2615),	func = SetIgnoreFilter,	arg1 = "faction2615IgnoreFilter",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2615) and DF() end	}
	list[#list+1] = {text = GetFaction(2574),	func = SetIgnoreFilter,	arg1 = "faction2574IgnoreFilter",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2574) and DF() end	}
...
do
	...
	local highlightingSubmenu = {
		...
		{text = GetFaction(2564),	func = SetHighlighFaction,	arg1 = "faction2564Highlight",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2564) and DF() end	},
		{text = GetFaction(2615),	func = SetHighlighFaction,	arg1 = "faction2615Highlight",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2615) and DF() end	},
		{text = GetFaction(2574),	func = SetHighlighFaction,	arg1 = "faction2574Highlight",	checkable = true,	shownFunc = function() return WorldQuestList:IsFactionAvailable(2574) and DF() end	},
	}
