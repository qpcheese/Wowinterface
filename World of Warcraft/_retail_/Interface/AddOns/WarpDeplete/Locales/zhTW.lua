...
L["Choose the alignment for the captions on the timer and forces bars"] = "選擇計時條和進度條的標題對齊方式"
L["Choose where the clear times for bosses will be displayed"] = "選擇首領擊殺時間的顯示位置"
...
L["WarpDeplete will not display the count for you current pull."] = "WarpDeplete 將不會顯示傲慢觸發警告或你目前拉怪的進度計數."
