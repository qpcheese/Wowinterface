...
L["Show forces percent above 100%"] = true
L["Show forces count in tooltip"] = true
L["Show forces percentages exceeding 100% for the above format options"] = true
...
L["Shows the current forces percentage including pull (e.g. 87.84%)"] = true
