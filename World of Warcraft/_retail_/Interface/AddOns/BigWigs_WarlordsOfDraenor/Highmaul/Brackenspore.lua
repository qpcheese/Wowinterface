...
local mod, CL = BigWigs:NewBoss("Brackenspore", 1228, 1196)
...
function mod:OnEngage()
	...
	self:DelayedMessage(159996, 40, "red", CL.soon:format(CL.count:format(self:SpellName(159996), infestingSporesCount)))
...
function mod:InfestingSpores(args)
	...
	self:DelayedMessage(args.spellId, 53, "red", CL.soon:format(CL.count:format(args.spellName, infestingSporesCount)))
end
