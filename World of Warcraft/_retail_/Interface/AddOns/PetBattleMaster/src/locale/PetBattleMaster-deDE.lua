...
L["Adds some information to the tooltip, whether the corresponding pet is already owned by the player"] = "Ergänzt den Tooltip eines Pets um die Information, ob der Spieler es bereits besitzt"
...
L[" No matching pets where found in stable."] = " Es wurden keine passenden Pets im Stall gefunden."
...
L[" Possible matches are: "] = " Mögliche Kandidaten wären: "
...
L["The ID of the %s'th member of the active team \"%s\" has changed."] = "Die ID des %s. Pet vom aktuellen Team \"%s\" hat sich geändert."
L["Tooltip attachment"] = "Tooltip-Erweiterung"
L["TOOLTIP_LEVEL"] = "(%s)"
