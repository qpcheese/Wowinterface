...
-- Settings.lua
	...
	-- Interface tab
		...
		L.REPLACE_QUEST_TOOLTIPS = "Заменить Подсказки Заданий";
		L.REPLACE_QUEST_TOOLTIPS_TOOLTIP = "Включите данную опцию, чтобы заменить подсказки заданий по умолчанию на подсказки ATT с дополнительной информацией.";
