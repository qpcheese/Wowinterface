...
function module:Recolor(color1, color2, color3, color4, desaturation)
    ...
    for _,texture in pairs({
        ...
        ProfessionsCustomerOrdersFrame.Form.PaymentContainer.DurationDropDown.Left,
        ProfessionsCustomerOrdersFrame.Form.PaymentContainer.DurationDropDown.Middle,
        ProfessionsCustomerOrdersFrame.Form.PaymentContainer.DurationDropDown.Right,
        ...
        ProfessionsCustomerOrdersFrame.Form.OrderRecipientDropDown.Left,
        ProfessionsCustomerOrdersFrame.Form.OrderRecipientDropDown.Middle,
        ProfessionsCustomerOrdersFrame.Form.OrderRecipientDropDown.Right,
        ProfessionsCustomerOrdersFrame.Form.MinimumQuality.DropDown.Left,
        ProfessionsCustomerOrdersFrame.Form.MinimumQuality.DropDown.Middle,
        ProfessionsCustomerOrdersFrame.Form.MinimumQuality.DropDown.Right
    }) do 
