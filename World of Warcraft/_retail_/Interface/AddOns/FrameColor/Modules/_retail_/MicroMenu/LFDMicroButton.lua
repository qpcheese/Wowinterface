...
local module = addon:NewModule("LFDMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = LFDMicroButton:GetNormalTexture()
textures.highlight = LFDMicroButton:GetHighlightTexture()
textures.pushed = LFDMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["LFDMicroButton"]
