...
local module = addon:NewModule("ProfessionMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = ProfessionMicroButton:GetNormalTexture()
textures.highlight = ProfessionMicroButton:GetHighlightTexture()
textures.pushed = ProfessionMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["ProfessionMicroButton"]
