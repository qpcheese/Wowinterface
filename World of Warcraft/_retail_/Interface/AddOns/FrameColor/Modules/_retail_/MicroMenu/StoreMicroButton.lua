...
local module = addon:NewModule("StoreMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = StoreMicroButton:GetNormalTexture()
textures.highlight = StoreMicroButton:GetHighlightTexture()
textures.pushed = StoreMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["StoreMicroButton"]
