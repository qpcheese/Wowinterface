...
local module = addon:NewModule("PlayerSpellsMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = PlayerSpellsMicroButton:GetNormalTexture()
textures.highlight = PlayerSpellsMicroButton:GetHighlightTexture()
textures.pushed = PlayerSpellsMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["PlayerSpellsMicroButton"]
