...
local module = addon:NewModule("CollectionsMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = CollectionsMicroButton:GetNormalTexture()
textures.highlight = CollectionsMicroButton:GetHighlightTexture()
textures.pushed = CollectionsMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["CollectionsMicroButton"]
