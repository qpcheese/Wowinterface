...
local module = addon:NewModule("QuestLogMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = QuestLogMicroButton:GetNormalTexture()
textures.highlight = QuestLogMicroButton:GetHighlightTexture()
textures.pushed = QuestLogMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["QuestLogMicroButton"]
