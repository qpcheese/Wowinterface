...
local module = addon:NewModule("TalentMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = TalentMicroButton:GetNormalTexture()
textures.highlight = TalentMicroButton:GetHighlightTexture()
textures.pushed = TalentMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["TalentMicroButton"]
