...
local module = addon:NewModule("SpellbookMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = SpellbookMicroButton:GetNormalTexture()
textures.highlight = SpellbookMicroButton:GetHighlightTexture()
textures.pushed = SpellbookMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["SpellbookMicroButton"]
