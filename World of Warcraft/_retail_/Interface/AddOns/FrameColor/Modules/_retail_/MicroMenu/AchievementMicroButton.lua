...
local module = addon:NewModule("AchievementMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = AchievementMicroButton:GetNormalTexture()
textures.highlight = AchievementMicroButton:GetHighlightTexture()
textures.pushed = AchievementMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["AchievementMicroButton"]
