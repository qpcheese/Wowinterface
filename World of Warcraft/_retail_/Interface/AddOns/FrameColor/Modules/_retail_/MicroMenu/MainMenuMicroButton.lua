...
local module = addon:NewModule("MainMenuMicroButton")
local color1, color2, color3

local textures = {}
textures.normal = MainMenuMicroButton:GetNormalTexture()
textures.highlight = MainMenuMicroButton:GetHighlightTexture()
textures.pushed = MainMenuMicroButton:GetPushedTexture()

function module:OnEnable()
    local dbObj = addon.db.profile["MicroMenu"]["MainMenuMicroButton"]
