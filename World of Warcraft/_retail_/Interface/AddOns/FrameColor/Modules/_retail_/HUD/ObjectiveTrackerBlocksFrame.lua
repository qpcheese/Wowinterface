...
local module = addon:NewModule("ObjectiveTrackerBlocksFrame")
local color1

function module:OnEnable()
    local dbObj = addon.db.profile["HUD"]["ObjectiveTrackerBlocksFrame"]
...
function module:Recolor(color1, desaturation)
    for _,v in pairs ({ObjectiveTrackerBlocksFrame:GetChildren()}) do
