do
	...
	function class:Setup(castercombat,targetcombat,localtime)
		...
		if(self.baseduration)then
			...
			self.expirytime=localtime+self.baseduration
	...
	function class:Step(elapsed)
		...
		if(self.expirytime)then		
			--print("Aura will expire ",self.targetcombat.localtime,self.expirytime)
			if(self.targetcombat.localtime>=self.expirytime)then
