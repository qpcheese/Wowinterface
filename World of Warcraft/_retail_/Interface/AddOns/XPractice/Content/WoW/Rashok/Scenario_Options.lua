do
	...
	XPRACTICE.RASHOK.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.RASHOK.Scenario_Options
	
	local savedataname="RASHOK"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.RASHOK.Scenario
	end
