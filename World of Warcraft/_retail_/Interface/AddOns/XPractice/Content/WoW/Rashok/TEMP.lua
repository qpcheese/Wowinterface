do
	...
	do	
		...
		XPRACTICE.RASHOK.Spell_SetRole=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_SetRole
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_SetSoak=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_SetSoak
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_Brez=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_Brez
	...
	do
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_PallyBubble=XPRACTICE.inheritsFrom(super)
		
		local class=XPRACTICE.RASHOK.Spell_PallyBubble
			function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Bubble)"
	...
	do
		...
		XPRACTICE.RASHOK.Aura_PallyBubble = XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Aura_PallyBubble
		...
		function class:OnApply(localtime)
			...
			local visual=XPRACTICE.RASHOK.PallyBubbleVisual.new()
	...
	do
		...
		XPRACTICE.RASHOK.PallyBubbleVisual=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.PallyBubbleVisual
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_ChangeMap=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_ChangeMap
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_CallToArms=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_CallToArms
		...
		function class:CompleteCastingEffect(castendtime,spellinstancepointer)	
			...
			if((not scenario.tempmenu.currentmenu) or scenario.tempmenu.currentmenu.menuclass~=XPRACTICE.CallToArmsInterface)then
				...
				scenario.tempmenu.currentmenu.extradata="CALL_TO_ARMS JOIN RASHOK 1"
			else
				scenario.tempmenu:UnloadCurrentMenu()
			end			
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_MoveBoss=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_MoveBoss
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_SetTanks=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_SetTanks
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.RASHOK.Spell_ClearAll=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_ClearAll
		function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Clear)"
	...
	function class.HandleCustom_CLEAR_ALL(self,sender,args)		
		...
		for k,v in pairs(scenario.multiplayer.allplayers)do
			local auras=v.combatmodule.auras:GetAurasByClassIfExistIncludingNewAuras(XPRACTICE.RASHOK.Aura_ConductiveMark)
			for i=1,#auras do
				auras[i]:Die()
			end
		end		
