do
	...
	XPRACTICE.RASHOK.RaidTargeting={}
	
	function XPRACTICE.RASHOK.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.RASHOK.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.RASHOK.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.RASHOK.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.RASHOK.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
