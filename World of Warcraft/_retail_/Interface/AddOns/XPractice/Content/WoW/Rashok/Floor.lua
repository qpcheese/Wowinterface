do
	...
	do
		...
		XPRACTICE.RASHOK.Floor=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Floor
		...
		function class:TransitionTo(index)
			if(XPRACTICE.RASHOK.FloorData.DrawMap[index])then
				...
				XPRACTICE.RASHOK.Bosses.CreateBosses(self.scenario,index)
			...
			if(self.transitionout)then
				...
				if(not stillinprogress)then	
					...
					if(self.transitionpending)then
						...
						if(XPRACTICE.RASHOK.FloorData.DrawMap[self.transitioninindex])then
							for i=1,#self.actors do
						...
						XPRACTICE.RASHOK.FloorData.DrawMap[self.transitioninindex](self.environment,self)
