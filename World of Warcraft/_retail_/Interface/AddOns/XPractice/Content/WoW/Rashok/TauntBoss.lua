...
do
	do	
		...
		XPRACTICE.RASHOK.Spell_TauntBoss=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASHOK.Spell_TauntBoss
...
do
	...
	function class.HandleCustom_TAUNTBOSS(self,sender,args)
		...
		player.combatmodule:ApplyAuraByClass(XPRACTICE.RASHOK.Aura_TauntBoss,boss.combatmodule,player.environment.localtime)
...
do
	...
	XPRACTICE.RASHOK.Aura_TauntBoss = XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.RASHOK.Aura_TauntBoss
