do
	...
	do
		...
		XPRACTICE.SMOLDERON.Floor=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SMOLDERON.Floor
		...
		function class:TransitionTo(index)
			if(XPRACTICE.AMIRDRASSILRAIDMAPS.FloorData.DrawMap[index])then
				...
				XPRACTICE.SMOLDERON.Bosses.CreateBosses(self.scenario,index)
