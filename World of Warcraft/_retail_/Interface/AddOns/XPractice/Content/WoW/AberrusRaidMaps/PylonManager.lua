...
--TODO: phase 2+3 area denial hex effects around pillars
	...
	XPRACTICE.ABERRUSRAIDMAPS.Pylon = {}
	XPRACTICE.ABERRUSRAIDMAPS.Pylon.__index = XPRACTICE.ABERRUSRAIDMAPS.Pylon
	function XPRACTICE.ABERRUSRAIDMAPS.Pylon.new()
		local self=setmetatable({}, XPRACTICE.ABERRUSRAIDMAPS.Pylon)	
		return self
	end
	local class=XPRACTICE.ABERRUSRAIDMAPS.Pylon
...
do
	...
	XPRACTICE.ABERRUSRAIDMAPS.PylonManager=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.ABERRUSRAIDMAPS.PylonManager
	...
	function class:NewPylon(x,y)
		local pylon=XPRACTICE.ABERRUSRAIDMAPS.Pylon.new()
					...
					elseif(pylon.pylonstate>pylon.targetpylonstate)then
						...
						if(prevstate>0.4 and pylon.pylonstate<=0.4)then
							if(pylon.tyranny)then
								pylon.tyranny=false
								local orb=XPRACTICE.ABERRUSRAIDMAPS.TyrannyOrb.new()
