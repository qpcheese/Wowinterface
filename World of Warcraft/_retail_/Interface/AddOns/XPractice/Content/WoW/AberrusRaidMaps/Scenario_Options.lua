do
	...
	XPRACTICE.ABERRUSRAIDMAPS.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.ABERRUSRAIDMAPS.Scenario_Options
	
	local savedataname="ABERRUSRAIDMAPS"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.ABERRUSRAIDMAPS.Scenario
	end
