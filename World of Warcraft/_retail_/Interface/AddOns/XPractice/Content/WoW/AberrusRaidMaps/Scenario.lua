...
do
	...
	XPRACTICE.ABERRUSRAIDMAPS.Scenario=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.ABERRUSRAIDMAPS.Scenario
	
	--XPRACTICE.ABERRUSRAIDMAPS.NPCID=180990
	--XPRACTICE.ABERRUSRAIDMAPS.NPCID=180991
	--XPRACTICE.ABERRUSRAIDMAPS.NPCID=180992
	XPRACTICE.ABERRUSRAIDMAPS.NPCID=14663
	

	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		
		self.savedataname="ABERRUSRAIDMAPS"
		self.npcid=XPRACTICE.ABERRUSRAIDMAPS.NPCID
	...
	function class:Populate()
		...
		self.collision=XPRACTICE.ABERRUSRAIDMAPS.Collision.new()
		...
		-- self.auratracker=XPRACTICE.ABERRUSRAIDMAPS.ExplosiveRunes_AuraTracker.new()				
		...
		-- local boss=XPRACTICE.ABERRUSRAIDMAPS.TheJailer.new()
		-- self.boss=boss	
		...
		-- self.layout=XPRACTICE.ABERRUSRAIDMAPS.Layout.new()
		-- self.layout:Setup(self.game.environment_gameplay,self)
		
		local floorobj
		floorobj=XPRACTICE.ABERRUSRAIDMAPS.Floor.new()
		...
		self.multiplayer=XPRACTICE.ABERRUSRAIDMAPS.Multiplayer.new()	-- inherits multiplayerv2
		...
		self.worldmarkercontroller=XPRACTICE.ABERRUSRAIDMAPS.WorldMarkerController.new()
		self.worldmarkercontroller:Setup(self.game.environment_gameplay)
		
		self.customeffectcontroller=XPRACTICE.ABERRUSRAIDMAPS.CustomEffectController.new()
		...
		XPRACTICE.OptionsMenuButton.debugbuttony=XPRACTICE.OptionsMenuButton.debugbuttony+45	
		local changemapbuttons=XPRACTICE.ABERRUSRAIDMAPS.ChangeMap.QuickButtons(156,380,self)
		...
		--self.tauntbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_TauntBoss,self.spellbunny,"TAUNT\nBOSS")
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
			XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_ChangeMap,self.spellbunny,"TEST")		
		
		--self.roarbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_Roar,self.spellbunny,"ROAR")
		--self.pallybubblebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_PallyBubble,self.spellbunny,"INVUL\n5 SEC")
		...
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52		
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_MoveBoss,self.spellbunny,"MOVE\nBOSS")
		...
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_CallToArms,self.spellbunny,"CALL")
		tinsert(extrabuttons,button)
		...
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_Brez,self.spellbunny,"ANKH")		
		

		--self.phase1button=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_ResetPhase1,self.spellbunny,"GOTO\nPHASE1",9)
		
		
		-- self.swirlsyncstopbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_SwirlSync_Stop,self.spellbunny,"SWIRL\nSTOP")
		-- self.resetstacksbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_ResetStacks,self.spellbunny,"RESET\nSTACK")
		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		-- self.humanappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_HumanAppearance,self.spellbunny,"HMN")
		-- self.lichappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.ABERRUSRAIDMAPS.Spell_LichAppearance,self.spellbunny,"LICH")		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		...
		-- self.schedule=XPRACTICE.ABERRUSRAIDMAPS.Schedule.new()
		...
		if(self.multiplayer.joinedsolo)then
			...
			self.floor:TransitionTo(XPRACTICE.ABERRUSRAIDMAPS.FloorData.KAZZARA)
		else
	...
	function class:Brez()
		local auras=self.player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.ABERRUSRAIDMAPS.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:BrezOther(player)
		local auras=player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.ABERRUSRAIDMAPS.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:AttemptKillPlayer(player,ignorebubble)
		...
		local auras=player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.ABERRUSRAIDMAPS.Aura_PallyBubble)
	...
	function class:PlaceHintArrow(x,y)
		...
		local arrow=XPRACTICE.ABERRUSRAIDMAPS.HintArrow.new()
	...
	function class:PlaceBossHintArrow(x,y)
		...
		local arrow=XPRACTICE.ABERRUSRAIDMAPS.BossHintArrow.new()
	...
	XPRACTICE.ScenarioList.RegisterScenario(XPRACTICE.ABERRUSRAIDMAPS.Scenario,"Aberrus, the Shadowed Crucible","Raid Maps","SCENARIO")
