do
	...
	XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting={}
	
	function XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.ABERRUSRAIDMAPS.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
