do
	...
	do
		...
		XPRACTICE.ABERRUSRAIDMAPS.Floor=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.ABERRUSRAIDMAPS.Floor
		...
		function class:TransitionTo(index)
			if(XPRACTICE.ABERRUSRAIDMAPS.FloorData.DrawMap[index])then
				...
				XPRACTICE.ABERRUSRAIDMAPS.Bosses.CreateBosses(self.scenario,index)
			...
			if(self.transitionout)then
				...
				if(not stillinprogress)then	
					...
					if(self.transitionpending)then
						...
						if(XPRACTICE.ABERRUSRAIDMAPS.FloorData.DrawMap[self.transitioninindex])then
							for i=1,#self.actors do
						...
						XPRACTICE.ABERRUSRAIDMAPS.FloorData.DrawMap[self.transitioninindex](self.environment,self)
