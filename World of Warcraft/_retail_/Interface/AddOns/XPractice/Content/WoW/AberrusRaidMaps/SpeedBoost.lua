...
do
	do	
		...
		XPRACTICE.ABERRUSRAIDMAPS.Spell_Sprint=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.ABERRUSRAIDMAPS.Spell_Sprint
	...
	do	
		...
		XPRACTICE.ABERRUSRAIDMAPS.SprintVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.ABERRUSRAIDMAPS.SprintVisualEffect
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.ABERRUSRAIDMAPS.Spell_Roar=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.ABERRUSRAIDMAPS.Spell_Roar
	...
	do	
		local super=XPRACTICE.WoWObject
		XPRACTICE.ABERRUSRAIDMAPS.RoarVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.ABERRUSRAIDMAPS.RoarVisualEffect
