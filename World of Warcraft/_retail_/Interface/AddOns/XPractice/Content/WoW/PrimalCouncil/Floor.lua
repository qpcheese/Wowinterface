do
	...
	do
		...
		XPRACTICE.PRIMALCOUNCIL.Floor=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.PRIMALCOUNCIL.Floor
		...
		function class:TransitionTo(index)
			if(XPRACTICE.PRIMALCOUNCIL.FloorData.DrawMap[index])then
				...
				XPRACTICE.PRIMALCOUNCIL.Bosses.CreateBosses(self.scenario,index)
			...
			if(self.transitionout)then
				...
				if(not stillinprogress)then	
					...
					if(self.transitionpending)then
						...
						if(XPRACTICE.PRIMALCOUNCIL.FloorData.DrawMap[self.transitioninindex])then
							for i=1,#self.actors do
						...
						XPRACTICE.PRIMALCOUNCIL.FloorData.DrawMap[self.transitioninindex](self.environment,self)
