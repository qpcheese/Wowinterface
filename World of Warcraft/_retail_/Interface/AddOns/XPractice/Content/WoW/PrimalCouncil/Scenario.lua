...
do
	...
	XPRACTICE.PRIMALCOUNCIL.Scenario=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.PRIMALCOUNCIL.Scenario

	XPRACTICE.PRIMALCOUNCIL.NPCID=187768
	

	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		
		self.savedataname="PRIMALCOUNCIL"
		self.npcid=XPRACTICE.PRIMALCOUNCIL.NPCID
	...
	function class:Populate()
		...
		self.collision=XPRACTICE.PRIMALCOUNCIL.Collision.new()
		...
		player.position={x=-15.8,y=24.1,z=0}
		player.orientation.yaw=-57.04/180*math.pi;player.orientation_displayed.yaw=player.orientation.yaw
		...
		local debufficon=XPRACTICE.PRIMALCOUNCIL.ConductiveMarkDebuffIcon.new()
		...
		local debufficon=XPRACTICE.PRIMALCOUNCIL.PrimalBlizzardDebuffIcon.new()
		debufficon:Setup(self.game.environment_gameplay)
		...
		-- local boss=XPRACTICE.PRIMALCOUNCIL.TheJailer.new()
		-- self.boss=boss	
		...
		-- self.layout=XPRACTICE.PRIMALCOUNCIL.Layout.new()
		-- self.layout:Setup(self.game.environment_gameplay,self)
		
		local floorobj
		floorobj=XPRACTICE.PRIMALCOUNCIL.Floor.new()
		...
		self.worldmarkercontroller=XPRACTICE.PRIMALCOUNCIL.WorldMarkerController.new()
		self.worldmarkercontroller:Setup(self.game.environment_gameplay)
			
		
		self.floor:TransitionTo(XPRACTICE.PRIMALCOUNCIL.FloorData.COUNCIL)		
		local scenario=self
		

		
		
		self.multiplayer=XPRACTICE.PRIMALCOUNCIL.Multiplayer.new()	-- inherits multiplayerv2
		...
		button=class.QuickCollapseButton(self.game.environment_gameplay,self,buttongroup,"Boss abilities")
		...
		-- XPRACTICE.OptionsMenuButton.debugbuttony=XPRACTICE.OptionsMenuButton.debugbuttony+45		
		-- local changemapbuttons=XPRACTICE.PRIMALCOUNCIL.ChangeMap.QuickButtons(156,310,self)
		...
		--self.tauntbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_TauntBoss,self.spellbunny,"TAUNT\nBOSS")
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
			XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_ChangeMap,self.spellbunny,"TEST")		
		
		--self.roarbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_Roar,self.spellbunny,"ROAR")
		--self.pallybubblebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_PallyBubble,self.spellbunny,"INVUL\n5 SEC")
		...
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52		
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_MoveBoss,self.spellbunny,"MOVE\nBOSS")
		tinsert(bosscontrolbuttons,button)
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_EarthenPillar,self.bosses[3],"EARTH\nPILLAR",9,nil,"earthenpillar")
		tinsert(bosscontrolbuttons,button)
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_ConductiveMark,self.bosses[2],"MARK",nil,nil,"conductivemark")
		tinsert(bosscontrolbuttons,button)
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_MeteorAxe,self.bosses[4],"METEO\nAXE",nil,nil,"meteoraxe")
		tinsert(bosscontrolbuttons,button)		
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_PrimalBlizzard,self.bosses[1],"BLIZZ",nil,nil,"primalblizzard")
		tinsert(bosscontrolbuttons,button)				
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_ClearAll,self.spellbunny,"CLEAR")
		tinsert(bosscontrolbuttons,button)
		...
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_CallToArms,self.spellbunny,"CALL")
		tinsert(extrabuttons,button)
		...
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_Brez,self.spellbunny,"ANKH")		
		
		

		--self.phase1button=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_ResetPhase1,self.spellbunny,"GOTO\nPHASE1",9)
		
		
		-- self.swirlsyncstopbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_SwirlSync_Stop,self.spellbunny,"SWIRL\nSTOP")
		-- self.resetstacksbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_ResetStacks,self.spellbunny,"RESET\nSTACK")
		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		-- self.humanappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_HumanAppearance,self.spellbunny,"HMN")
		-- self.lichappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.PRIMALCOUNCIL.Spell_LichAppearance,self.spellbunny,"LICH")		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		...
		-- self.schedule=XPRACTICE.PRIMALCOUNCIL.Schedule.new()
	...
	function class:Step(elapsed)
		...
		for i=#self.earthenpillars,1,-1 do
			if(self.earthenpillars[i].dead)then
				tremove(self.earthenpillars,i)
			end
		end
		for i=#self.firezones,1,-1 do
			if(self.firezones[i].dead)then
				tremove(self.firezones,i)
			end
		end
	...
	function class:Brez()
		local auras=self.player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.PRIMALCOUNCIL.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:BrezOther(player)
		local auras=player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.PRIMALCOUNCIL.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:AttemptKillPlayer(player,ignorebubble)
		...
		local auras=player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.PRIMALCOUNCIL.Aura_PallyBubble)
	...
	function class:PlaceHintArrow(x,y)
		...
		local arrow=XPRACTICE.PRIMALCOUNCIL.HintArrow.new()
	...
	function class:PlaceBossHintArrow(x,y)
		...
		local arrow=XPRACTICE.PRIMALCOUNCIL.BossHintArrow.new()
	...
	XPRACTICE.ScenarioList.RegisterScenario(XPRACTICE.PRIMALCOUNCIL.Scenario,"Conductive Mark","(The Primal Council)","SCENARIO")
	--XPRACTICE.ScenarioList.RegisterScenario(XPRACTICE.PRIMALCOUNCIL.Scenario,"10.0","Vault of the Incarnates","SEPARATOR")
end
