do
	...
	do	
		...
		XPRACTICE.VOTIRAIDMAPS.Spell_SetRole=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_SetRole
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_SetSoak=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_SetSoak
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_Brez=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_Brez
	...
	do
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_PallyBubble=XPRACTICE.inheritsFrom(super)
		
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_PallyBubble
			function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Bubble)"
	...
	do
		...
		XPRACTICE.VOTIRAIDMAPS.Aura_PallyBubble = XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Aura_PallyBubble
		...
		function class:OnApply(localtime)
			...
			local visual=XPRACTICE.VOTIRAIDMAPS.PallyBubbleVisual.new()
	...
	do
		...
		XPRACTICE.VOTIRAIDMAPS.PallyBubbleVisual=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.PallyBubbleVisual
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_ChangeMap=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_ChangeMap
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_CallToArms=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_CallToArms
		...
		function class:CompleteCastingEffect(castendtime,spellinstancepointer)	
			...
			if((not scenario.tempmenu.currentmenu) or scenario.tempmenu.currentmenu.menuclass~=XPRACTICE.CallToArmsInterface)then
				...
				scenario.tempmenu.currentmenu.extradata="CALL_TO_ARMS JOIN VOTIRAIDMAPS 2"
			else
				scenario.tempmenu:UnloadCurrentMenu()
			end			
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_MoveBoss=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_MoveBoss
		...
		function class:CompleteCastingEffect(castendtime,spellinstancepointer)	
			...
			if(self.scenario.mapindex==3 or self.scenario.mapindex==8)then				
