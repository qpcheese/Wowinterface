...
do
	do	
		...
		XPRACTICE.VOTIRAIDMAPS.Spell_Sprint=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_Sprint
	...
	do	
		...
		XPRACTICE.VOTIRAIDMAPS.SprintVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.SprintVisualEffect
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.VOTIRAIDMAPS.Spell_Roar=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.Spell_Roar
	...
	do	
		local super=XPRACTICE.WoWObject
		XPRACTICE.VOTIRAIDMAPS.RoarVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.VOTIRAIDMAPS.RoarVisualEffect
