do
	...
	XPRACTICE.VOTIRAIDMAPS.HintArrow=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.VOTIRAIDMAPS.HintArrow
...
do
	local super=XPRACTICE.VOTIRAIDMAPS.HintArrow
	XPRACTICE.VOTIRAIDMAPS.BossHintArrow=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.VOTIRAIDMAPS.BossHintArrow
