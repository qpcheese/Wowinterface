do
	...
	XPRACTICE.VOTIRAIDMAPS.RaidTargeting={}
	
	function XPRACTICE.VOTIRAIDMAPS.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.VOTIRAIDMAPS.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.VOTIRAIDMAPS.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.VOTIRAIDMAPS.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.VOTIRAIDMAPS.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
