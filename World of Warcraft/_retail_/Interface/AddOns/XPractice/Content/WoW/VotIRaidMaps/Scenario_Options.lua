do
	...
	XPRACTICE.VOTIRAIDMAPS.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.VOTIRAIDMAPS.Scenario_Options
	
	local savedataname="VOTIRAIDMAPS"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.VOTIRAIDMAPS.Scenario
	end
