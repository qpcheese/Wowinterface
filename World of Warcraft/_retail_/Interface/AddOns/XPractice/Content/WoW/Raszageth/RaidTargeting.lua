do
	...
	XPRACTICE.RASZAGETH.RaidTargeting={}
	
	function XPRACTICE.RASZAGETH.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.RASZAGETH.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.RASZAGETH.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.RASZAGETH.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.RASZAGETH.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
