do
	...
	XPRACTICE.RASZAGETH.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.RASZAGETH.Scenario_Options
	
	local savedataname="RASZAGETH"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.RASZAGETH.Scenario
	end
