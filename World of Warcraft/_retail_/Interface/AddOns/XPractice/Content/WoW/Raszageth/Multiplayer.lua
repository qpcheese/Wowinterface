do	
	...
	XPRACTICE.RASZAGETH.Multiplayer=XPRACTICE.inheritsFrom(super)
	...
	function class.Handle_HELLO(self,sender,args)
		...
		--print(XPRACTICE.MULTIPLAYERV2.Multiplayerv2.Handle, XPRACTICE.RASZAGETH.Handle)
	...
	function class.HandleCustom_CHANGEMAP(self,sender,args)
		...
		local name=tostring(XPRACTICE.RASZAGETH.ChangeMap.BossNames[i])
		if(name)then
