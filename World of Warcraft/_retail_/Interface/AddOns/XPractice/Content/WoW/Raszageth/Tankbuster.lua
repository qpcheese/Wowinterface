do
	...
	do	
		...
		XPRACTICE.RASZAGETH.Spell_Tankbuster=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASZAGETH.Spell_Tankbuster
		function class:SetCustomInfo()
		...
		function class:CompleteCastingAnimationFunction(spellinstancepointer)
			spellinstancepointer.castercombat.mob.animationmodule:PlayAnimation(XPRACTICE.RASZAGETH.AnimationList.Bite)
		end
