do
	...
	do
		...
		XPRACTICE.RASZAGETH.Floor=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.RASZAGETH.Floor
		...
		function class:TransitionTo(index)
			if(XPRACTICE.RASZAGETH.FloorData.DrawMap[index])then
				...
				XPRACTICE.RASZAGETH.Bosses.CreateBosses(self.scenario,index)
			...
			if(self.transitionout)then
				...
				if(not stillinprogress)then	
					...
					if(self.transitionpending)then
						...
						if(XPRACTICE.RASZAGETH.FloorData.DrawMap[self.transitioninindex])then
							for i=1,#self.actors do
						...
						XPRACTICE.RASZAGETH.FloorData.DrawMap[self.transitioninindex](self.environment,self)
