do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.HintArrow=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.HintArrow
...
do
	local super=XPRACTICE.AMIRDRASSILRAIDMAPS.HintArrow
	XPRACTICE.AMIRDRASSILRAIDMAPS.BossHintArrow=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.BossHintArrow
