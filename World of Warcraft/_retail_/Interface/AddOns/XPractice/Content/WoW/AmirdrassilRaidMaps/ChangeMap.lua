...
do
	XPRACTICE.AMIRDRASSILRAIDMAPS.ChangeMap={}
	
	XPRACTICE.AMIRDRASSILRAIDMAPS.ChangeMap.BossNames={"Gnarlroot","Igira","Council","Smolderon","Larodar","Volcoross","Nymue","Tindral","Fyrakk"}
	
	function XPRACTICE.AMIRDRASSILRAIDMAPS.ChangeMap.QuickButtons(x,y,scenario)
		local buttons={}
		local xx=0
		local yy=0
		--for i=1,10 do
		for i=1,9 do
			local text=XPRACTICE.AMIRDRASSILRAIDMAPS.ChangeMap.BossNames[i]
			if(text)then
				local menubutton
