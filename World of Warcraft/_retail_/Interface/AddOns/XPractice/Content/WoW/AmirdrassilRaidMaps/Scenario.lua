...
do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario
	

	XPRACTICE.AMIRDRASSILRAIDMAPS.NPCID=2549
	

	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		
		self.savedataname="AMIRDRASSILRAIDMAPS"
		self.npcid=XPRACTICE.AMIRDRASSILRAIDMAPS.NPCID
	...
	function class:Populate()
		...
		self.collision=XPRACTICE.AMIRDRASSILRAIDMAPS.Collision.new()
		...
		player.position={x=23.7,y=0,z=0}
		...
		-- self.auratracker=XPRACTICE.AMIRDRASSILRAIDMAPS.ExplosiveRunes_AuraTracker.new()				
		...
		-- local boss=XPRACTICE.AMIRDRASSILRAIDMAPS.TheJailer.new()
		-- self.boss=boss	
		...
		-- self.layout=XPRACTICE.AMIRDRASSILRAIDMAPS.Layout.new()
		-- self.layout:Setup(self.game.environment_gameplay,self)
		
		local floorobj
		floorobj=XPRACTICE.AMIRDRASSILRAIDMAPS.Floor.new()
		...
		local scenery
		scenery=XPRACTICE.AMIRDRASSILRAIDMAPS.Scenery.new()
		scenery:Setup(self.game.environment_gameplay)
		scenery.scenario=self
		self.scenery=scenery
		scenery.visiblefromallphases=true
		...
		self.multiplayer=XPRACTICE.AMIRDRASSILRAIDMAPS.Multiplayer.new()	-- inherits multiplayerv2
		...
		--TODO: convert WMC to multisolid too
		self.worldmarkercontroller=XPRACTICE.AMIRDRASSILRAIDMAPS.WorldMarkerController.new()
		...
		XPRACTICE.OptionsMenuButton.debugbuttony=XPRACTICE.OptionsMenuButton.debugbuttony+45	
		local changemapbuttons=XPRACTICE.AMIRDRASSILRAIDMAPS.ChangeMap.QuickButtons(156,380,self)
		...
		--self.tauntbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_TauntBoss,self.spellbunny,"TAUNT\nBOSS")
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
			XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_ChangeMap,self.spellbunny,"TEST")		
		
		--self.roarbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_Roar,self.spellbunny,"ROAR")
		--self.pallybubblebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_PallyBubble,self.spellbunny,"INVUL\n5 SEC")
		...
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52		
		XPRACTICE.BossDebugButton.debugbuttonx=XPRACTICE.BossDebugButton.debugbuttonx+52
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_MoveBoss,self.spellbunny,"MOVE\nBOSS")
		...
		button=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_CallToArms,self.spellbunny,"CALL")
		tinsert(extrabuttons,button)
		...
		self.brezbutton=XPRACTICE.BossDebugButton_v2.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_Brez,self.spellbunny,"ANKH")		
		

		--self.phase1button=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_ResetPhase1,self.spellbunny,"GOTO\nPHASE1",9)
		
		
		-- self.swirlsyncstopbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_SwirlSync_Stop,self.spellbunny,"SWIRL\nSTOP")
		-- self.resetstacksbutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_ResetStacks,self.spellbunny,"RESET\nSTACK")
		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		-- self.humanappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_HumanAppearance,self.spellbunny,"HMN")
		-- self.lichappearancebutton=XPRACTICE.BossDebugButton.QuickButton(self.game.environment_gameplay,self,XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_LichAppearance,self.spellbunny,"LICH")		
		-- XPRACTICE.BossDebugButton.CarriageReturn()
		...
		-- self.schedule=XPRACTICE.AMIRDRASSILRAIDMAPS.Schedule.new()
		...
		if(self.multiplayer.joinedsolo)then
			...
			self.floor:TransitionTo(XPRACTICE.AMIRDRASSILRAIDMAPS.FloorData.GNARLROOT)
			--self.scenery:SendEverything()
		else
			self.statuslabel:SetText("Welcome to Aberrus, the Shadowed Crucible!  Wait a moment for raid communications...",5.0)
		...
		-- --self.customeffectcontroller:SetGroundEffect(self.player.paddedguid,2,"GGR"..string.char(10+48),0,0)
		-- self.customeffectcontroller:SetGroundEffect(self.player.paddedguid,2,"GGC"..string.char(10+48),0,0)
		-- -- self.customeffectcontroller:SetGroundEffect(self.player.paddedguid,2,"GRS"..string.char(5+48),10,0)
		-- -- self.customeffectcontroller:SetGroundEffect(self.player.paddedguid,2,"GGC"..string.char(10+48),30,0)
		
		-- --self.customeffectcontroller:SetAttachEffect(self.player.paddedguid,3,"GBR"..string.char(10+48),self.player.paddedguid)
		-- --C_Timer.After(0.5,function()self.customeffectcontroller:SetAttachEffect(self.player.paddedguid,3,"PRC"..string.char(10+48),"ALL-XXXXXXXXXXXX")end)
		-- C_Timer.After(0.5,function()self.customeffectcontroller:SetAttachEffect(self.player.paddedguid,3,"PBC"..string.char(3+48),"ALL-XXXXXXXXXXXX")end)
		-- self.customeffectcontroller:SetAttachEffect(self.player.paddedguid,4,"ERB"..string.char(20+48),"ENEMY-001-XXXXXX")
	...
	function class:Step(elapsed)
		...
		if(self.waitingforcommstimer and self.waitingforcommstimer>0)then
			...
			if(self.waitingforcommstimer<=0)then
				...
				self.statuslabel:SetText("No raid officers found.  Moving to first boss's room.",5.0)
	...
	function class:Brez()
		local auras=self.player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.AMIRDRASSILRAIDMAPS.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:BrezOther(player)
		local auras=player.combatmodule.auras:GetAurasByClassIfExist(XPRACTICE.AMIRDRASSILRAIDMAPS.Aura_ChangePhaseForced)
		if(#auras>0)then 			
			return 
		end				
	...
	function class:PlaceHintArrow(x,y)
		...
		local arrow=XPRACTICE.AMIRDRASSILRAIDMAPS.HintArrow.new()
	...
	function class:PlaceBossHintArrow(x,y)
		...
		local arrow=XPRACTICE.AMIRDRASSILRAIDMAPS.BossHintArrow.new()
	...
	XPRACTICE.ScenarioList.RegisterScenario(XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario,"Amirdrassil, the Dream's Hope","Raid Maps","SCENARIO")
