do
	...
	do	
		...
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_SetRole=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_SetRole
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_SetSoak=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_SetSoak
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_Brez=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_Brez
	...
	do
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_PallyBubble=XPRACTICE.inheritsFrom(super)
		
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_PallyBubble
			function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Bubble)"
	...
	do
		...
		XPRACTICE.AMIRDRASSILRAIDMAPS.Aura_PallyBubble = XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Aura_PallyBubble
		...
		function class:OnApply(localtime)
			...
			local visual=XPRACTICE.AMIRDRASSILRAIDMAPS.PallyBubbleVisual.new()
	...
	do
		...
		XPRACTICE.AMIRDRASSILRAIDMAPS.PallyBubbleVisual=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.PallyBubbleVisual
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_ChangeMap=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_ChangeMap
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_CallToArms=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_CallToArms
		...
		function class:CompleteCastingEffect(castendtime,spellinstancepointer)	
			...
			if((not scenario.tempmenu.currentmenu) or scenario.tempmenu.currentmenu.menuclass~=XPRACTICE.CallToArmsInterface)then
				...
				scenario.tempmenu.currentmenu.extradata="CALL_TO_ARMS JOIN AMIRDRASSILRAIDMAPS 1"
			else
				scenario.tempmenu:UnloadCurrentMenu()
			end			
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_MoveBoss=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Spell_MoveBoss
