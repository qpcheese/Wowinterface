do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.CustomEffect=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.CustomEffect
	...
	--static
	function XPRACTICE.AMIRDRASSILRAIDMAPS.CustomEffect.RadiusToChar(radius)
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.CustomEffect.CodeToString(code)
		local result=""
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.CustomEffect.MakeActorFromCode(multisolid,code,x,y)
