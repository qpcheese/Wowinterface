do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting={}
	
	function XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.AMIRDRASSILRAIDMAPS.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
