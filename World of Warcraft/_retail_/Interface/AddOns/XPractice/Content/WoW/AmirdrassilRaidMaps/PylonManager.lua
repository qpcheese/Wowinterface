...
--TODO: phase 2+3 area denial hex effects around pillars
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon = {}
	XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon.__index = XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon
	function XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon.new()
		local self=setmetatable({}, XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon)	
		return self
	end
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon
...
do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.PylonManager=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.PylonManager
	...
	function class:NewPylon(x,y)
		local pylon=XPRACTICE.AMIRDRASSILRAIDMAPS.Pylon.new()
					...
					elseif(pylon.pylonstate>pylon.targetpylonstate)then
						...
						if(prevstate>0.4 and pylon.pylonstate<=0.4)then
							if(pylon.tyranny)then
								pylon.tyranny=false
								local orb=XPRACTICE.AMIRDRASSILRAIDMAPS.TyrannyOrb.new()
