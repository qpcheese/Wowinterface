do
	...
	XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario_Options
	
	local savedataname="AMIRDRASSILRAIDMAPS"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.AMIRDRASSILRAIDMAPS.Scenario
	end
	...
	XPRACTICE.GetSaveDataDefaults[savedataname]=function()
		...
		--TODO NEXT: mousepicker for worldmarkers
