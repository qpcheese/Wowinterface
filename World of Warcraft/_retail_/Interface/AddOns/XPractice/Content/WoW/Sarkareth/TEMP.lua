do
	...
	do	
		...
		XPRACTICE.SARKARETH2.Spell_SetRole=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_SetRole
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_SetSoak=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_SetSoak
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_Brez=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_Brez
	...
	do
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_PallyBubble=XPRACTICE.inheritsFrom(super)
		
		local class=XPRACTICE.SARKARETH2.Spell_PallyBubble
			function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Bubble)"
	...
	do
		...
		XPRACTICE.SARKARETH2.Aura_PallyBubble = XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Aura_PallyBubble
		...
		function class:OnApply(localtime)
			...
			local visual=XPRACTICE.SARKARETH2.PallyBubbleVisual.new()
	...
	do
		...
		XPRACTICE.SARKARETH2.PallyBubbleVisual=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.PallyBubbleVisual
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_ChangeMap=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_ChangeMap
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_CallToArms=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_CallToArms
		...
		function class:CompleteCastingEffect(castendtime,spellinstancepointer)	
			...
			if((not scenario.tempmenu.currentmenu) or scenario.tempmenu.currentmenu.menuclass~=XPRACTICE.CallToArmsInterface)then
				...
				scenario.tempmenu.currentmenu.extradata="CALL_TO_ARMS JOIN SARKARETH 1"
			else
				scenario.tempmenu:UnloadCurrentMenu()
			end			
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_MoveBoss=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_MoveBoss
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_SetTanks=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_SetTanks
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.SARKARETH2.Spell_ClearAll=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.SARKARETH2.Spell_ClearAll
		function class:SetCustomInfo()
			super.SetCustomInfo(self)
			self.name="(Clear)"
	...
	local class=XPRACTICE.SARKARETH2.Multiplayer	
	function class.HandleCustom_CLEAR_ALL(self,sender,args)		
		local scenario=self.scenario
		for k,v in pairs(scenario.multiplayer.allplayers)do
			local auras=v.combatmodule.auras:GetAurasByClassIfExistIncludingNewAuras(XPRACTICE.SARKARETH2.Aura_ConductiveMark)
			for i=1,#auras do
				auras[i]:Die()
			end
		end		
