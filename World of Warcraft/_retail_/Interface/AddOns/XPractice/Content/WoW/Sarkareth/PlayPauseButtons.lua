do
	...
	function XPRACTICE.SARKARETH2.SetupPlayPauseButtons(scenario)
		scenario.playbutton=Button(scenario,"Play",25,355,nil,nil,function()
														scenario.multiplayer:FormatAndSendCustom("UNPAUSE") end)
		scenario.pausebutton=Button(scenario,"Pause",25+80+14,355,nil,nil,function()
