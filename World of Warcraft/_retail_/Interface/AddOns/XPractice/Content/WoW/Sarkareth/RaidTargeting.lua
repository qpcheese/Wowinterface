do
	...
	XPRACTICE.SARKARETH2.RaidTargeting={}
	
	function XPRACTICE.SARKARETH2.RaidTargeting.RemoveRandomMDPS(pool)
		local mdps={}
		for i=1,#pool do
			if(pool[i].mdps)then
	...
	function XPRACTICE.SARKARETH2.RaidTargeting.RemoveRandomRDPS(pool)
		local rdps={}
		for i=1,#pool do
			if(pool[i].rdps)then
	...
	function XPRACTICE.SARKARETH2.RaidTargeting.RemoveRandomDPS(pool)
		local dps={}
		for i=1,#pool do
	...
	function XPRACTICE.SARKARETH2.RaidTargeting.RemoveRandomHealer(pool)
		local healer={}
		for i=1,#pool do
	...
	function XPRACTICE.SARKARETH2.RaidTargeting.RemoveRandomTank(pool)
		local tank={}
		for i=1,#pool do
