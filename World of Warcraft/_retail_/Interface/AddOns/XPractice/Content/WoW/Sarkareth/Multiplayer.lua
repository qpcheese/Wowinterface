do	
	...
	XPRACTICE.SARKARETH2.Multiplayer=XPRACTICE.inheritsFrom(super)
	...
	function class.Handle_HELLO(self,sender,args)
		...
		--print(XPRACTICE.MULTIPLAYERV2.Multiplayerv2.Handle, XPRACTICE.SARKARETH2.Handle)
	...
	function class.HandleCustom_CHANGEMAP(self,sender,args)
		...
		local name=tostring(XPRACTICE.SARKARETH2.ChangeMap.BossNames[i])
		if(name)then
	...
	function class.HandleCustom_MOVE_BOSS(self,sender,args)
		...
		if(boss)then
			...
			-- boss.destx=nil;boss.desty=nil;boss.destyaw=nil;boss.reactiontime=0
			...
			boss:SuggestDestination(args[2],args[3],0,sender)
			
			boss.combatmodule.tauntmovetarget=nil
			-- boss:SetTargetMob(nil)
			
			--boss.combatmodule:StopAutoAttacking()
		end
	end		
