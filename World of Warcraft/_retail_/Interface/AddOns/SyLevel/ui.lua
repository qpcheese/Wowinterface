...
function frame:CreateOptions()
	...
	title:SetText'SyLevel - Now with 30% less toxic radiation!'
...
do
	local CheckBox_OnClick = function(self)
		...
		if(self:GetChecked()) then
			...
			-- SyLevel:RegisterFilterOnPipe(pipe, "Item level text")
		else
			SyLevel:DisablePipe(pipe)
			-- SyLevel:UnregisterFilterOnPipe(pipe, "Item level text")
		end
