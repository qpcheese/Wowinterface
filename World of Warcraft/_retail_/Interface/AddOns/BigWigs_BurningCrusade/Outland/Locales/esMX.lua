local L = BigWigs:NewBossLocale("Doomwalker", "esMX")
...
L = BigWigs:NewBossLocale("Doom Lord Kazzak", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Gruul the Dragonkiller", "esMX")
if L then
...
L = BigWigs:NewBossLocale("High King Maulgar", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Magtheridon", "esMX")
if L then
	L.escape = "Libreación"
