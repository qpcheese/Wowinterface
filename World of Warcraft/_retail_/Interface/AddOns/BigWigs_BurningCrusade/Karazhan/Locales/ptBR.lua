...
L = BigWigs:NewBossLocale("Romulo & Julianne", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("The Crone", "ptBR")
if L then
	--L.name = "The Crone"
...
L = BigWigs:NewBossLocale("Hyakiss the Lurker", "ptBR")
if L then
	L.name = "Hyakiss, a Tocaieira"
end
