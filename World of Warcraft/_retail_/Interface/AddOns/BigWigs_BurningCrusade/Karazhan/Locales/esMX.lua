local L = BigWigs:NewBossLocale("Attumen the Huntsman Raid", "esMX")
...
L = BigWigs:NewBossLocale("The Curator Raid", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Maiden of Virtue Raid", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Prince Malchezaar", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Nightbane Raid", "esMX")
if L then
	L.name = "Nocturno"
...
L = BigWigs:NewBossLocale("Terestian Illhoof", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Big Bad Wolf", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Crone", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Hyakiss the Lurker", "esMX")
if L then
