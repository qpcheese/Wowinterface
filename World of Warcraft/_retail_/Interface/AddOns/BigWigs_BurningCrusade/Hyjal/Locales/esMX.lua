local L = BigWigs:NewBossLocale("ArchimondeHyjal", "esMX")
...
L = BigWigs:NewBossLocale("Azgalor", "esMX")
if L then
	L.howl_bar = "~Aullido"
	L.howl_message = "Silencio de área"
end

L = BigWigs:NewBossLocale("Kaz'rogal", "esMX")
if L then
	L.mark_bar = "~Marca (%d)"
	L.mark_warn = "Marca en 5 seg"
end

L = BigWigs:NewBossLocale("Hyjal Summit Trash", "esMX")
if L then
	L.waves = "Oleadas"
