...
local bfaPets = {
	...
	["Needleback Pup"] = {
		...
		type = CONSTANTS.ITEM_TYPES.PET,
		method = CONSTANTS.DETECTION_METHODS.USE,
		items = { 173996, 173950, 173988, 173994, 173997, 173989, 173990, 173992, 173991, 173993, 173949 },
	...
	["Shadefeather Hatchling"] = {
		...
		type = CONSTANTS.ITEM_TYPES.PET,
		method = CONSTANTS.DETECTION_METHODS.USE,
		items = { 173997, 173989, 173996, 173950, 173993, 173991, 173949, 173994, 173988 },
