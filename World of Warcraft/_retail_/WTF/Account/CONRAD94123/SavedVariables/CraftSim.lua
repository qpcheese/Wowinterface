...
CraftSimGGUIConfig = {
	["savedPos_CRAFT_DATA"] = {
		["offsetX"] = 822.0004272460938,
		["offsetY"] = -396.9998779296875,
	},
	["savedPos_SPEC_INFO"] = {
		["offsetX"] = 650.9998168945312,
		["offsetY"] = 282.9998168945313,
	},
	["savedPos_RECIPE_SCAN"] = {
		["offsetX"] = -159,
		["offsetY"] = 50.00006103515625,
	},
	["savedPos_STAT_WEIGHTS"] = {
		["offsetX"] = 174.9998779296875,
		["offsetY"] = -218.0008239746094,
	},
	["savedPos_CRAFT_RESULTS"] = {
		["offsetX"] = 832.3621215820312,
		["offsetY"] = 19.11395263671875,
	},
	["savedPos_INFO"] = {
		["offsetX"] = -207.0003662109375,
		["offsetY"] = 63.00006103515625,
	},
	["savedPos_COST_DETAILS"] = {
		["offsetX"] = -180.9999694824219,
		["offsetY"] = -290.0001525878906,
	},
	["savedPos_TOP_GEAR"] = {
	...
	["realm"] = {
		["Ragnaros"] = {
			["Otplorettv-Ragnaros"] = {
				["history"] = {
					{
						["to"] = "I would restrict \"application\" and \"recruitment\" channel on discord to mythic raider and up, right now trials and \"raider\" can see it",
					...
					{
						["to"] = "sec",
						["timestamp"] = 1686222848126,
					}, -- [16]
					{
						["to"] = "one sec wait",
						["timestamp"] = 1686222853867,
					}, -- [17]
					{
						["to"] = "right now you only have raider rank in discc, but you have raider and mythic raider ingame",
					...
					}, -- [27]
					{
						...
						["timestamp"] = 1686222966756,
					}, -- [28]
					{
						["to"] = "i mean it was just something i noticed",
						["timestamp"] = 1686222983148,
					}, -- [29]
					{
						["to"] = "i have realized lately that other guilds really play dirty when it comes to stealing members",
			...
			["Stìles-Ragnaros"] = {
				["history"] = {
					...
					}, -- [7]
					{
						...
						["timestamp"] = 1685859079547,
					}, -- [8]
					{
						["to"] = "maybe they can make frozen orb like it is in pvp",
						["timestamp"] = 1685859105389,
					}, -- [9]
					{
						["to"] = "and turn icy veins in to a passive haste buff",
						["timestamp"] = 1685859129975,
					}, -- [10]
					{
						["to"] = "and they are removing rune of power, cant get better",
					...
					}, -- [14]
					{
						...
						["timestamp"] = 1685860200035,
					}, -- [15]
					{
						["to"] = "fire and arcane have new changes so far",
						["timestamp"] = 1685860214261,
					}, -- [16]
					{
						["to"] = "Fire got like multiple new talents ",
						["timestamp"] = 1685860295779,
					}, -- [17]
					{
						["to"] = "arcane got two new",
						["timestamp"] = 1685860318686,
					}, -- [18]
					{
						["to"] = "to help with out of burst aoe",
						["timestamp"] = 1685860326196,
					}, -- [19]
					{
						["to"] = "tried them out yesterday, very good change",
						["timestamp"] = 1685860346658,
					}, -- [20]
				},
			},
			["Chaosbrìnger-Ragnaros"] = {
				["history"] = {
					{
						["to"] = "shiropo",
						["timestamp"] = 1686043644690,
					}, -- [1]
					{
						["to"] = "can u help me get a firey soul?",
						["timestamp"] = 1686043651536,
					}, -- [2]
					{
						["to"] = "or two",
					...
					}, -- [7]
					{
						...
						["timestamp"] = 1686043693528,
					}, -- [8]
					{
						["to"] = "okay",
						["timestamp"] = 1686043971002,
					}, -- [9]
					{
						["to"] = "fk",
					...
					{
						["to"] = "gogo",
						["timestamp"] = 1686044367150,
					}, -- [18]
					{
						["to"] = "wtf russia are fucking retarded",
					...
					}, -- [20]
					{
						...
						["timestamp"] = 1686044839146,
					}, -- [21]
					{
						["to"] = "in ukraine, literally flooding the country",
			...
			["Helpdotcom-Ragnaros"] = {
				["history"] = {
					...
					}, -- [12]
					{
						...
						["timestamp"] = 1686720579383,
					}, -- [13]
					{
						["to"] = "literally doubled over night",
						["timestamp"] = 1686720588771,
					}, -- [14]
				},
			},
			["Jereunter-Ragnaros"] = {
				["history"] = {
					...
					}, -- [2]
					{
						...
						["timestamp"] = 1686060991447,
					}, -- [3]
					{
						["to"] = "just wanna check so theres nothing i have missed",
						["timestamp"] = 1686060999431,
					}, -- [4]
					{
						["to"] = "for me it says first(DBRecent, DBMinbuyout)",
					...
					{
						["to"] = "OOH",
						["timestamp"] = 1686061043970,
					}, -- [7]
					{
						["to"] = "under \"general\" i had price source set to auctionator",
						["timestamp"] = 1686061053470,
					}, -- [8]
					{
						["to"] = "maybe i should change to TSM",
					...
					{
						["to"] = "yes yes i have",
						["timestamp"] = 1686061069692,
					}, -- [12]
					{
						["to"] = "now lets see",
						["timestamp"] = 1686061122502,
					}, -- [13]
					{
						["to"] = "so i should try with a few even if it says -10, just to see if i profit, and if its a steady incline i should buy bulk?",
					...
					{
						["to"] = "ill try",
						["timestamp"] = 1686061520509,
					}, -- [32]
					{
						["to"] = "500g profit of 2k worth of ore",
						["timestamp"] = 1686061623942,
					}, -- [33]
					{
						["to"] = "using all resource procs",
					...
					}, -- [38]
					{
						...
						["timestamp"] = 1686061742372,
					}, -- [39]
					{
						["to"] = "R3 was more profit per 1k , but not much",
						["timestamp"] = 1686062302216,
					}, -- [40]
				},
			},
			["Fyshzel-Ragnaros"] = {
