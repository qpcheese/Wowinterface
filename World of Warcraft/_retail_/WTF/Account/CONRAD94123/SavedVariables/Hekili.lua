				...
				["Windwalker"] = {
					...
					["lists"] = {
						["opener"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.fae_exposure_damage.remains < 2 & ! debuff.skyreach_exhaustion.up",
						...
						["serenity_3t"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "set_bonus.tier31_2pc & combo_strike & buff.blackout_reinforcement.up",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "! debuff.skyreach_exhaustion.up * 20 & combo_strike",
								["action"] = "tiger_palm",
								["cycle_targets"] = 1,
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & spinning_crane_kick.max & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc",
							...
							}, -- [7]
							{
								...
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["interrupt_if"] = "!set_bonus.tier31_2pc||buff.fury_of_xuen_stacks.stack>90",
								["criteria"] = "buff.invokers_delight.up & ! set_bonus.tier31_2pc",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max & buff.blackout_reinforcement.up & set_bonus.tier31_2pc & prev.blackout_kick & talent.crane_vortex.enabled",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & ! buff.pressure_point.up",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [11]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & spinning_crane_kick.max & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [17]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [19]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [23]
							{
						...
						["serenity_st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & buff.serenity.remains < 1.5 & combo_strike & ! buff.blackout_reinforcement.remains & set_bonus.tier31_4pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [2]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.thunderfist.enabled & set_bonus.tier31_4pc",
								["action"] = "strike_of_the_windlord",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up & prev.rising_sun_kick & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & set_bonus.tier31_2pc & buff.blackout_reinforcement.up & prev.rising_sun_kick",
								["action"] = "blackout_kick",
							}, -- [11]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up & prev.fists_of_fury & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [12]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & buff.blackout_reinforcement.up & prev.fists_of_fury & set_bonus.tier31_2pc",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc & prev.fists_of_fury",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [14]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [16]
							{
						...
						["cd_serenity"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > 16 & ! variable.hold_xuen & talent.bonedust_brew.enabled & cooldown.bonedust_brew.remains <= 1 || buff.bloodlust.up || fight_remains < 25",
								["action"] = "invoke_xuen",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "( target.time_to_die > 16 || ! boss & cooldown.serenity.remains < 2 ) & fight_remains > 120 & ( ! trinket.t1.is.ashes_of_the_embersoul & ! trinket.t1.is.witherbarks_branch & ! trinket.t2.is.ashes_of_the_embersoul & ! trinket.t2.is.witherbarks_branch || ( trinket.t1.is.ashes_of_the_embersoul || trinket.t1.is.witherbarks_branch ) & ! trinket.t1.cooldown.remains || ( trinket.t2.is.ashes_of_the_embersoul || trinket.t2.is.witherbarks_branch ) & ! trinket.t2.cooldown.remains )",
								["action"] = "invoke_xuen",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > 16 & fight_remains < 60 & ( debuff.skyreach_exhaustion.remains < 2 || debuff.skyreach_exhaustion.remains > 55 ) & ! cooldown.serenity.remains & active_enemies < 3",
								["action"] = "invoke_xuen",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "! boss & talent.bonedust_brew.enabled & target.time_to_die > 16 & ! cooldown.serenity.remains & cooldown.bonedust_brew.remains < 2",
								["action"] = "invoke_xuen",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "buff.invokers_delight.up || ! buff.bonedust_brew.up & cooldown.xuen_the_white_tiger.remains & ! pet.xuen_the_white_tiger.active || cooldown.serenity.remains > 15 || boss & fight_remains < 30 & fight_remains > 10 || boss & fight_remains < 10",
								["action"] = "bonedust_brew",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "variable.sync_serenity & ( buff.invokers_delight.up || variable.hold_xuen & ( talent.drinking_horn_cover.enabled & fight_remains > 110 || ! talent.drinking_horn_cover.enabled & fight_remains > 105 ) ) || ! talent.invoke_xuen_the_white_tiger.enabled || fight_remains < 15",
								["action"] = "serenity",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "! variable.sync_serenity & ( buff.invokers_delight.up || cooldown.invoke_xuen_the_white_tiger.remains > fight_remains || fight_remains > ( cooldown.invoke_xuen_the_white_tiger.remains + 10 ) & fight_remains > 90 )",
								["action"] = "serenity",
							}, -- [9]
							{
								["enabled"] = true,
						...
						["default_st"] = {
							{
								["enabled"] = true,
								["action"] = "tiger_palm",
								["criteria"] = "combo_strike & chi < 2 & ( cooldown.rising_sun_kick.remains < 1 || cooldown.fists_of_fury.remains < 1 || cooldown.strike_of_the_windlord.remains < 1 ) & buff.teachings_of_the_monastery.stack < 3",
								["description"] = "1 Target",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "chi = 1 & ( ! cooldown.rising_sun_kick.remains || ! cooldown.strike_of_the_windlord.remains ) || chi = 2 & ! cooldown.fists_of_fury.remains & cooldown.rising_sun_kick.remains",
								["action"] = "expel_harm",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "buff.domineering_arrogance.up & talent.thunderfist.enabled & talent.serenity.enabled & cooldown.invoke_xuen_the_white_tiger.remains > 20 || fight_remains < 5 || talent.thunderfist.enabled & debuff.skyreach_exhaustion.remains > 10 & ! buff.domineering_arrogance.up || talent.thunderfist.enabled & debuff.skyreach_exhaustion.remains > 35 & ! talent.serenity.enabled",
								["action"] = "strike_of_the_windlord",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & set_bonus.tier31_2pc & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [4]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.pressure_point.up & debuff.skyreach_exhaustion.remains < 55 & ( debuff.fae_exposure_damage.remains > 2 || cooldown.faeline_stomp.remains )",
								["action"] = "fists_of_fury",
							}, -- [6]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.blackout_reinforcement.up & cooldown.rising_sun_kick.remains & combo_strike & buff.dance_of_chiji.up",
								["action"] = "blackout_kick",
							}, -- [11]
							{
								["action"] = "rising_sun_kick",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.blackout_reinforcement.up & combo_strike",
								["action"] = "blackout_kick",
							}, -- [13]
							{
								["action"] = "fists_of_fury",
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [20]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & buff.bonedust_brew.up & combo_strike & spinning_crane_kick.modifier >= 2.7",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [22]
							{
						...
						["default_3t"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [2]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.shadowboxing_treads.enabled & combo_strike & buff.blackout_reinforcement.up",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [6]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & buff.bonedust_brew.up & combo_strike",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [9]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & cooldown.fists_of_fury.remains < 3 & buff.chi_energy.stack > 15",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [20]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & cooldown.rising_sun_kick.remains & cooldown.fists_of_fury.remains & chi > 4 & ( ( talent.storm_earth_and_fire.enabled & ! talent.bonedust_brew.enabled ) || ( talent.serenity.enabled ) )",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [22]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & ( combo_strike & chi > 5 & talent.storm_earth_and_fire.enabled || combo_strike & chi > 4 & talent.serenity.enabled )",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [26]
						},
						["default_aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & ! talent.hit_combo.enabled & spinning_crane_kick.max & buff.bonedust_brew.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [2]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & buff.bonedust_brew.up & combo_strike & spinning_crane_kick.max",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [5]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & cooldown.fists_of_fury.remains < 5 & buff.chi_energy.stack > 10",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [16]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ( cooldown.fists_of_fury.remains > 3 || chi > 2 ) & spinning_crane_kick.max & buff.bloodlust.up & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [19]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ( cooldown.fists_of_fury.remains > 3 || chi > 2 ) & spinning_crane_kick.max & buff.invokers_delight.up & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [20]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ( cooldown.fists_of_fury.remains > 3 || chi > 4 ) & spinning_crane_kick.max",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [23]
							{
						...
						["serenity_aoelust"] = {
							{
								...
								["criteria"] = "debuff.fae_exposure_damage.remains < 1",
								["action"] = "faeline_stomp",
								["description"] = "Serenity AoE Lust",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "set_bonus.tier31_4pc & talent.thunderfist.enabled",
								["action"] = "strike_of_the_windlord",
							}, -- [2]
							{
								["enabled"] = true,
							...
							}, -- [3]
							{
								...
								["action"] = "fists_of_fury",
								["cycle_targets"] = 1,
								["interrupt_if"] = "buff.chi_energy.stack=30",
								["criteria"] = "talent.jade_ignition.enabled",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc & buff.bonedust_brew.up & active_enemies > 4",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & set_bonus.tier31_2pc & combo_strike & ! buff.blackout_reinforcement.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [6]
							{
								...
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["criteria"] = "buff.invokers_delight.up & set_bonus.tier31_2pc & ( active_enemies > 5 & buff.transfer_the_power.stack > 5 || active_enemies > 6 || active_enemies > 4 & ! talent.crane_vortex.enabled & buff.transfer_the_power.stack > 5 )",
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "fists_of_fury",
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["criteria"] = "! set_bonus.tier30_2pc & ! buff.invokers_delight.up & set_bonus.tier31_2pc & ( ! buff.bonedust_brew.up || active_enemies > 10 ) & ( buff.transfer_the_power.stack = 10 & ! talent.crane_vortex.enabled || active_enemies > 5 & talent.crane_vortex.enabled & buff.transfer_the_power.stack = 10 || active_enemies > 14 || active_enemies > 12 & ! talent.crane_vortex.enabled )",
							}, -- [8]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & set_bonus.tier31_2pc & combo_strike & buff.blackout_reinforcement.up & prev.blackout_kick & buff.dance_of_chiji.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [12]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies < 6 & combo_strike & set_bonus.tier31_2pc",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [15]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [22]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [24]
							{
								["enabled"] = true,
								["criteria"] = "! debuff.skyreach_exhaustion.up * 20 & combo_strike & active_enemies = 5",
								["action"] = "tiger_palm",
								["cycle_targets"] = 1,
							}, -- [25]
							{
						...
						["serenity_4t"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & buff.serenity.remains < 1.5 & combo_strike & ! buff.blackout_reinforcement.remains & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [2]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [4]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & set_bonus.tier31_2pc & combo_strike & ! buff.blackout_reinforcement.up & talent.crane_vortex.enabled",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [8]
							{
							...
							}, -- [9]
							{
								...
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["criteria"] = "buff.invokers_delight.up & set_bonus.tier31_2pc & buff.transfer_the_power.stack > 5 & ! talent.crane_vortex.enabled & buff.bloodlust.up",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "buff.pressure_point.up & set_bonus.tier30_2pc",
						...
						["serenity_aoe"] = {
							...
							}, -- [6]
							{
								...
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["interrupt_if"] = "!set_bonus.tier30_2pc&set_bonus.tier31_2pc&(!buff.bonedust_brew.up||active_enemies>10)&(buff.transfer_the_power.stack=10&!talent.crane_vortex||active_enemies>5&talent.crane_vortex&buff.transfer_the_power.stack=10||active_enemies>14||active_enemies>12&!talent.crane_vortex)&!buff.bonedust_brew.up||buff.fury_of_xuen_stacks.stack>90",
								["criteria"] = "buff.invokers_delight.up & set_bonus.tier31_2pc & ( ! buff.bonedust_brew.up || active_enemies > 10 ) & ( buff.transfer_the_power.stack = 10 & ! talent.crane_vortex.enabled || active_enemies > 5 & talent.crane_vortex.enabled & buff.transfer_the_power.stack = 10 || active_enemies > 14 || active_enemies > 12 & ! talent.crane_vortex.enabled )",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & ! spinning_crane_kick.max & talent.shadowboxing_treads.enabled",
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & set_bonus.tier31_2pc & combo_strike & buff.blackout_reinforcement.up & prev.blackout_kick",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [13]
							{
						...
						["cd_sef"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > 25 & fight_remains > 120 & ( ! trinket.t1.is.ashes_of_the_embersoul & ! trinket.t1.is.witherbarks_branch & ! trinket.t2.is.ashes_of_the_embersoul & ! trinket.t2.is.witherbarks_branch || ( trinket.t1.is.ashes_of_the_embersoul || trinket.t1.is.witherbarks_branch ) & ! trinket.t1.cooldown.remains || ( trinket.t2.is.ashes_of_the_embersoul || trinket.t2.is.witherbarks_branch ) & ! trinket.t2.cooldown.remains )",
								["action"] = "invoke_xuen",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "fight_remains < 60 & ( debuff.skyreach_exhaustion.remains < 2 || debuff.skyreach_exhaustion.remains > 55 ) & ! cooldown.serenity.remains & active_enemies < 3",
								["action"] = "invoke_xuen",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "talent.bonedust_brew.enabled & ( boss & fight_remains < 30 & cooldown.bonedust_brew.remains < 4 & chi >= 4 || buff.bonedust_brew.up || ! spinning_crane_kick.max & active_enemies >= 3 & cooldown.bonedust_brew.remains <= 2 & chi >= 2 ) & ( pet.xuen_the_white_tiger.active || cooldown.invoke_xuen_the_white_tiger.remains > cooldown.storm_earth_and_fire.full_recharge_time )",
								["action"] = "storm_earth_and_fire",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "( ! buff.bonedust_brew.up & buff.storm_earth_and_fire.up & buff.storm_earth_and_fire.remains < 11 & spinning_crane_kick.max ) || ( ! buff.bonedust_brew.up & boss & fight_remains < 30 & fight_remains > 10 & spinning_crane_kick.max & chi >= 4 ) || boss & fight_remains < 10 || ( ( talent.skyreach.enabled || talent.skytouch.enabled ) & ! debuff.skyreach_exhaustion.up & active_enemies >= 4 & spinning_crane_kick.modifier >= 2 ) || ( pet.xuen_the_white_tiger.active & spinning_crane_kick.max & active_enemies >= 4 )",
								["action"] = "bonedust_brew",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["default"] = {
							...
							}, -- [2]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "! debuff.skyreach_exhaustion.remains < 1 & cooldown.rising_sun_kick.remains < 1 & ( set_bonus.tier30_2pc || active_enemies < 5 )",
							...
							}, -- [3]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "! debuff.skyreach_exhaustion.remains < 1 & cooldown.bonedust_brew.remains < 1 & active_enemies = 1",
								["var_name"] = "hold_tp_bdb",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "buff.serenity.up || buff.storm_earth_and_fire.up & pet.xuen_the_white_tiger.active || boss & fight_remains <= 30",
								["action"] = "potion",
								["description"] = "Potion",
							}, -- [5]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies = 1 & ! debuff.skyreach_exhaustion.remains & ( pet.xuen_the_white_tiger.active || cooldown.xuen_the_white_tiger.remains )",
								["action"] = "bonedust_brew",
								["description"] = "Use bdb before skyreach in st",
							}, -- [10]
							{
								["enabled"] = true,
								["action"] = "tiger_palm",
								["cycle_targets"] = 1,
								["description"] = "TP to not waste energy",
								["criteria"] = "! buff.serenity.up & energy > 50 & buff.teachings_of_the_monastery.stack < 3 & combo_strike & chi.max - chi >= ( 2 + buff.power_strikes.up ) & ( ! talent.invoke_xuen_the_white_tiger.enabled & ! talent.serenity.enabled || ( ( ! talent.skyreach.enabled & ! talent.skytouch.enabled ) || time > 5 || pet.xuen_the_white_tiger.active ) ) & ! variable.hold_tp_rsk & ( active_enemies > 1 || ! talent.bonedust_brew.enabled || talent.bonedust_brew.enabled & active_enemies = 1 & cooldown.bonedust_brew.remains )",
							}, -- [11]
							{
								["enabled"] = true,
								["action"] = "tiger_palm",
								...
								["criteria"] = "! buff.serenity.up & buff.teachings_of_the_monastery.stack < 3 & combo_strike & chi.max - chi >= ( 2 + buff.power_strikes.up ) & ( ! talent.invoke_xuen_the_white_tiger.enabled & ! talent.serenity.enabled || ( ( ! talent.skyreach.enabled & ! talent.skytouch.enabled ) || time > 5 || pet.xuen_the_white_tiger.active ) ) & ! variable.hold_tp_rsk & ( active_enemies > 1 || ! talent.bonedust_brew.enabled || talent.bonedust_brew.enabled & active_enemies = 1 & cooldown.bonedust_brew.remains )",
							}, -- [12]
							{
								["enabled"] = true,
						...
						["precombat"] = {
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["var_name"] = "sync_serenity",
								["value"] = "1",
								["criteria"] = "equipped.neltharions_call_to_dominance || equipped.ashes_of_the_embersoul || equipped.mirror_of_fractured_tomorrows || equipped.witherbarks_branch",
								["default"] = "0",
							}, -- [1]
							{
								["action"] = "summon_white_tiger_statue",
						...
						["fallthru"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.chi_energy.stack > 30 - 5 * active_enemies & buff.storm_earth_and_fire.down & ( cooldown.rising_sun_kick.remains > 2 & cooldown.fists_of_fury.remains > 2 || cooldown.rising_sun_kick.remains < 3 & cooldown.fists_of_fury.remains > 3 & chi > 3 || cooldown.rising_sun_kick.remains > 3 & cooldown.fists_of_fury.remains < 3 & chi > 4 || chi.max - chi <= 1 & energy.time_to_max < 2 ) || buff.chi_energy.stack > 10 & fight_remains < 7",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [9]
							{
						...
						["default_4t"] = {
							{
								["enabled"] = true,
								["action"] = "tiger_palm",
								["criteria"] = "combo_strike & chi < 2 & ( cooldown.fists_of_fury.remains < 1 || cooldown.strike_of_the_windlord.remains < 1 ) & buff.teachings_of_the_monastery.stack < 3",
								["description"] = "4 Targets",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & cooldown.fists_of_fury.remains > 3 & buff.chi_energy.stack > 10",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [14]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ( cooldown.fists_of_fury.remains > 3 || chi > 4 )",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [21]
							{
						...
						["serenity_lust"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up & set_bonus.tier31_2pc & active_enemies > 2",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [4]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & buff.blackout_reinforcement.up & active_enemies > 2",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & ( active_enemies < 3 || ! set_bonus.tier31_2pc )",
								["action"] = "rising_sun_kick",
								["cycle_targets"] = 1,
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "combo_strike & buff.blackout_reinforcement.up & prev.fists_of_fury & talent.shadowboxing_treads.enabled & set_bonus.tier31_2pc & ! talent.dance_of_chiji.enabled",
								["action"] = "blackout_kick",
								["cycle_targets"] = 1,
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & buff.dance_of_chiji.up & ! buff.blackout_reinforcement.up & prev.fists_of_fury & debuff.skyreach_exhaustion.remains > 55 & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [9]
							{
								...
								["cycle_targets"] = 1,
								["interrupt"] = "1",
								["criteria"] = "buff.invokers_delight.up & ( active_enemies < 3 || ! set_bonus.tier31_2pc )",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max & ! buff.blackout_reinforcement.up & active_enemies > 2 & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [11]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max & buff.blackout_reinforcement.up & active_enemies > 2 & prev.blackout_kick & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [12]
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & spinning_crane_kick.max & buff.bonedust_brew.up & active_enemies > 2 & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [13]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > duration & combo_strike & ! buff.blackout_reinforcement.up & buff.bonedust_brew.up & set_bonus.tier31_2pc",
								["action"] = "spinning_crane_kick",
								["cycle_targets"] = 1,
							}, -- [15]
							{
				...
				["Arcane"] = {
					...
					["lists"] = {
						["rotation"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "equipped.belorrelos_the_suncaller & trinket.belorrelos_the_suncaller.ready_cooldown & buff.siphon_storm.down & buff.arcane_surge.down & buff.arcane_charge.stack = buff.arcane_charge.max_stack",
						...
						["cooldown_phase"] = {
							...
							}, -- [8]
							{
								...
								["interrupt_if"] = "!gcd.remains&mana.pct>30&buff.nether_precision.up&!buff.arcane_artillery.up",
								["interrupt_immediate"] = "1",
								["criteria"] = "cooldown.radiant_spark.ready & buff.clearcasting.react & ( talent.nether_precision.enabled & ( buff.nether_precision.down || buff.nether_precision.remains < gcd.max ) ) & set_bonus.tier30_4pc",
								["interrupt_global"] = "1",
							}, -- [9]
							{
						...
						["precombat"] = {
							...
							}, -- [6]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( ( equipped.ashes_of_the_embersoul & equipped.mirror_of_fractured_tomorrows ) || ( equipped.nymues_unraveling_spindle & equipped.mirror_of_fractured_tomorrows ) )",
								["description"] = "Variable indicates double on use trinket setups",
								["var_name"] = "mirror_double_on_use",
							}, -- [7]
							{
								["enabled"] = true,
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( ( equipped.ashes_of_the_embersoul & equipped.balefire_branch ) || ( equipped.nymues_unraveling_spindle & equipped.balefire_branch ) || ( equipped.mirror_of_fractured_tomorrows & equipped.balefire_branch ) )",
								["var_name"] = "balefire_double_on_use",
							}, -- [8]
							{
								["enabled"] = true,
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( equipped.nymues_unraveling_spindle & equipped.ashes_of_the_embersoul )",
							...
							}, -- [9]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( equipped.balefire_branch & equipped.gladiators_badge )",
								["var_name"] = "badgebalefire_double_on_use",
							}, -- [10]
							{
								["enabled"] = true,
								["op"] = "set",
								...
								["var_name"] = "irideus_double_on_use",
							}, -- [11]
							{
								["action"] = "mirror_image",
								["enabled"] = true,
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( ( ( ! set_bonus.tier30_4pc & cooldown.arcane_surge.remains <= ( gcd.max * 4 ) & cooldown.radiant_spark.remains ) || ( set_bonus.tier30_4pc & prev_gcd.1.arcane_surge ) ) & ( ! variable.irideus_double_on_use || ! buff.bloodlust.up ) ) || fight_remains <= 20 || ( ( active_enemies >= variable.aoe_target_count ) & cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest )",
								["name"] = "timebreaching_talon",
								["action"] = "timebreaching_talon",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "( ( variable.badgebalefire_double_on_use & ( debuff.touch_of_the_magi.up || buff.arcane_surge.up || ( buff.siphon_storm.up & variable.opener ) ) ) || ( ! variable.badgebalefire_double_on_use & prev_gcd.1.arcane_surge ) ) || fight_remains <= 15 || ( ( active_enemies >= variable.aoe_target_count ) & cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest )",
								["name"] = "gladiators_badge",
								["action"] = "gladiators_badge",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "( ( ( ! set_bonus.tier30_4pc & cooldown.arcane_surge.remains <= gcd.max & buff.siphon_storm.remains < 20 ) || ( set_bonus.tier30_4pc & prev_gcd.1.arcane_surge ) ) & ( ! variable.balefire_double_on_use || ! buff.bloodlust.up ) ) || fight_remains <= 20 || ( ( active_enemies >= variable.aoe_target_count ) & cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest )",
								["name"] = "mirror_of_fractured_tomorrows",
								["action"] = "mirror_of_fractured_tomorrows",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "( buff.siphon_storm.up & ( ( buff.siphon_storm.remains < 15 & variable.balefire_double_on_use ) || ( buff.siphon_storm.remains < 20 & ! variable.balefire_double_on_use ) || set_bonus.tier30_4pc ) & ( cooldown.arcane_surge.remains < 10 || buff.arcane_surge.up ) & ( debuff.touch_of_the_magi.remains > 8 || cooldown.touch_of_the_magi.remains < 8 || equipped.belorrelos_the_suncaller & set_bonus.tier30_4pc ) ) || variable.badgebalefire_double_on_use & ( debuff.touch_of_the_magi.up || buff.arcane_surge.up || ( buff.siphon_storm.up & variable.opener ) ) || boss & fight_remains <= 15 || ( ( active_enemies >= variable.aoe_target_count ) & ( ( cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest ) || buff.siphon_storm.remains > 15 ) )",
								["name"] = "balefire_branch",
								["action"] = "balefire_branch",
							}, -- [16]
							{
								["enabled"] = true,
								["criteria"] = "( prev_gcd.1.arcane_surge & ! equipped.belorrelos_the_suncaller & ( ! variable.mirror_double_on_use || ! buff.bloodlust.up ) & ( ! variable.balefire_double_on_use || ! buff.bloodlust.up ) ) || fight_remains <= 20 || ( ( active_enemies >= variable.aoe_target_count ) & cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest ) || ( equipped.belorrelos_the_suncaller & ( buff.arcane_surge.remains > 12 || ( buff.siphon_storm.remains < 17.5 & variable.opener ) ) )",
								["name"] = "ashes_of_the_embersoul",
								["action"] = "ashes_of_the_embersoul",
							}, -- [17]
							{
								["enabled"] = true,
								["criteria"] = "( ( ( ! variable.opener & ! set_bonus.tier30_4pc & cooldown.arcane_surge.remains <= ( gcd.max * 4 ) & cooldown.radiant_spark.ready ) || ( set_bonus.tier30_4pc & cooldown.arcane_surge.remains <= ( gcd.max * 4 ) & cooldown.radiant_spark.ready ) || ( variable.opener & ! set_bonus.tier30_4pc & ( mana <= variable.opener_min_mana || buff.siphon_storm.remains < 19 ) ) ) & ( ! variable.mirror_double_on_use || ! buff.bloodlust.up ) & ( ! variable.balefire_double_on_use || ! buff.bloodlust.up ) & ( ! variable.ashes_double_on_use || ! buff.bloodlust.up ) ) || boss & fight_remains <= 24 || ( ( active_enemies >= variable.aoe_target_count ) & cooldown.arcane_surge.ready & prev_gcd.1.nether_tempest ) || ( equipped.belorrelos_the_suncaller & cooldown.touch_of_the_magi.remains < ( gcd.max * 6 ) )",
							...
							}, -- [25]
							{
								...
								["criteria"] = "gcd.remains & ! dot.radiant_spark.remains & ( ! variable.steroid_trinket_equipped || buff.siphon_storm.down )",
							}, -- [26]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["cds"] = {
							...
							}, -- [15]
							{
								...
								["criteria"] = "! stealthed.all & gcd.remains > gcd.max - 0.1 & buff.between_the_eyes.up || boss & fight_remains <= 5",
							...
							}, -- [16]
							{
								...
								["use_off_gcd"] = 1,
								["criteria"] = "! stealthed.mantle & time > 0 & ( ( ! trinket.t1.is.dragonfire_bomb_dispenser & trinket.t1.cooldown.remains > 10 || trinket.t2.cooldown.remains > 10 ) || cooldown.dragonfire_bomb_dispenser.charges > 2 || boss & fight_remains < 20 || ! trinket.t2.has_cooldown || ! trinket.t1.has_cooldown )",
							...
							}, -- [17]
							{
								...
								["action"] = "beacon_to_the_beyond",
								["use_off_gcd"] = 1,
								["criteria"] = "! stealthed.mantle & gcd.remains > gcd.max - 0.1 & buff.between_the_eyes.up || boss & fight_remains <= 5",
								["name"] = "beacon_to_the_beyond",
							}, -- [18]
							{
								["enabled"] = true,
						...
						["finish"] = {
							...
							}, -- [1]
							{
								...
								["action"] = "between_the_eyes",
								["description"] = "Crackshot builds use Between the Eyes outside of Stealth if Vanish or Dance will not come off cooldown within the next cast",
							}, -- [2]
							{
								["enabled"] = true,
					...
					["lists"] = {
						["stealthed"] = {
							{
								...
								["action"] = "shadowstrike",
								["description"] = "Always Strike fro Stealth",
							}, -- [1]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["description"] = "Finish when on Anaima charged combo points or max combo points.",
						...
						["finish"] = {
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( action.shadowstrike.used_for_danse || action.shuriken_storm.used_for_danse ) & ( action.eviscerate.used_for_danse || action.black_powder.used_for_danse || action.rupture.used_for_danse ) || ! talent.danse_macabre.enabled",
								["var_name"] = "secret_condition",
								["description"] = "Defines what abilitis need to be used for DM stacks before casting Secret Tchnique.",
							}, -- [1]
							{
								["enabled"] = true,
							...
							}, -- [8]
							{
								...
								["description"] = "Syncronizes Secret to Cold Blood if possible. Defualts to use once a builder and finisher is used.",
							}, -- [9]
							{
								["enabled"] = true,
								["action"] = "rupture",
						...
						["cds"] = {
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( ! equipped.witherbarks_branch & ! equipped.ashes_of_the_embersoul || ! equipped.witherbarks_branch & cooldown.witherbarks_branch.remains <= 8 || equipped.witherbarks_branch & cooldown.witherbarks_branch.remains <= 8 || equipped.bandolier_of_twisted_blades || talent.invigorating_shadowdust.enabled )",
							...
							}, -- [3]
							{
								...
								["action"] = "flagellation",
								["cycle_targets"] = 1,
								["description"] = "Defines Flagellation use in a stacked maner with trinkets and Shadow Blades",
							...
							}, -- [11]
							{
								...
								["action"] = "thistle_tea",
								["description"] = "Thistle Tea during Shadow Dance when close to max stacks, default use is for energy.",
							}, -- [12]
							{
								["enabled"] = true,
						...
						["stealth_cds"] = {
							...
							}, -- [1]
							{
								...
								["var_name"] = "rotten_cb",
								["description"] = "Helper variavle to check for Cold Blood and The Rotten buff.",
							}, -- [2]
							{
								["enabled"] = true,
							...
							}, -- [6]
							{
								...
								["action"] = "shadow_dance",
								["description"] = "Shadow dance when Rupture is up and syncronize depending on talent choice.",
							}, -- [7]
						},
						["build"] = {
							{
				...
				["Mistweaver"] = {
					...
					["lists"] = {
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "settings.single_zen_pulse",
								["action"] = "zen_pulse",
							}, -- [4]
							{
								["action"] = "chi_wave",
				...
				["Brewmaster"] = {
					...
					["lists"] = {
						...
						["rotation_pta"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( 1.1 > ( swing.mh.remains ) * ( 1 + spell_haste ) - swing.mh.two_hand )",
								["action"] = "spinning_crane_kick",
							}, -- [18]
							{
								["action"] = "expel_harm",
					...
					["lists"] = {
						...
						["cds"] = {
							...
							}, -- [4]
							{
								...
								["action"] = "belorrelos_the_suncaller",
								["use_off_gcd"] = 1,
								["criteria"] = "( gcd.remains > gcd.max - 0.1 || boss & fight_remains < 5 ) & time > 5",
								["name"] = "belorrelos_the_suncaller",
							}, -- [5]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["aoe"] = {
							{
								...
								["description"] = "AOE action list, Actually kinda clean now  Variables for AoE / Testing  This variable controls when you should start holding empowers for upcoming DR. - From my testing 4sec seems like the sweetspot, but it's very minor diff so far - Holding for more than 6 seconds it begins to become a loss.",
							}, -- [1]
							{
								["enabled"] = true,
								...
								["criteria"] = "target.time_to_die >= 32 || fight_remains < 30",
								["action"] = "dragonrage",
							}, -- [2]
							{
								["enabled"] = true,
							...
							}, -- [3]
							{
								...
								["criteria"] = "( ! talent.dragonrage.enabled || variable.next_dragonrage > variable.dr_prep_time_aoe || ! talent.animosity.enabled ) & ( buff.blazing_shards.remains < variable.r1_cast_time || buff.dragonrage.up ) & ( target.time_to_die >= 8 || fight_remains < 30 )",
								["list_name"] = "fb",
							}, -- [4]
							{
								["enabled"] = true,
								...
								["criteria"] = "buff.dragonrage.up || ! talent.dragonrage.enabled || ( cooldown.dragonrage.remains > variable.dr_prep_time_aoe & buff.blazing_shards.remains < variable.r1_cast_time ) & ( target.time_to_die >= 8 || fight_remains < 30 )",
								["list_name"] = "es",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["description"] = "Pyre logic with volatility.  Pyre on 3T+",
								["criteria"] = "talent.volatility.enabled & active_enemies >= 3",
								["action"] = "pyre",
							}, -- [9]
							{
								["enabled"] = true,
								["description"] = "Cast LF with burnout proc and leaping flames up as long as you have 0 EB",
								["criteria"] = "buff.burnout.up & buff.leaping_flames.up & ! buff.essence_burst.up & essence < essence.max - 1",
								["action"] = "living_flame",
							}, -- [10]
							{
								["enabled"] = true,
						...
						["trinkets"] = {
							{
								...
								["name"] = "spoils_of_neltharus",
								["action"] = "spoils_of_neltharus",
								["criteria"] = "buff.dragonrage.up & ( active_enemies >= 3 || ! buff.spoils_of_neltharus_vers.up || buff.dragonrage.remains + 4 * ( ( cooldown.eternity_surge.remains <= gcd.max * 2 ) + ( cooldown.fire_breath.remains <= gcd.max * 2 ) ) <= 18 ) || boss & fight_remains <= 20",
								["description"] = "With spoils try to fish for non vers buff before you using it on <=2T, use regardless of buff when 18s is left on DR. Don't fish when >=3T.",
							}, -- [1]
							{
								["enabled"] = true,
								["action"] = "trinket1",
						...
						["st"] = {
							...
							}, -- [1]
							{
								...
								["description"] = "Variable for when to start holding empowers.",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "raid_event.movement.in < 2 & ! buff.hover.up",
							...
							}, -- [4]
							{
								...
								["criteria"] = "cooldown.fire_breath.remains < 4 & cooldown.eternity_surge.remains < 10 & target.time_to_die >= 32 || fight_remains < 30",
								["action"] = "dragonrage",
							}, -- [5]
							{
								["enabled"] = true,
								["description"] = "Tip Eternity Surge without EBF - Tip Fire Breath with EBF",
								["criteria"] = "buff.dragonrage.up & ( cooldown.eternity_surge.up & ! cooldown.fire_breath.up & ! talent.everburning_flame.enabled ) || ( talent.everburning_flame.enabled & cooldown.fire_breath.up )",
								["action"] = "tip_the_scales",
							}, -- [6]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["description"] = "Cast Fire Breath  DS optimization: Only cast if current fight will last 8s+ or encounter ends in less than 30s",
								["criteria"] = "( ! talent.dragonrage.enabled || variable.next_dragonrage > variable.dr_prep_time_st || ! talent.animosity.enabled ) & ( buff.blazing_shards.remains < variable.r1_cast_time || buff.dragonrage.up ) & ( target.time_to_die >= 8 || fight_remains < 30 )",
								["list_name"] = "fb",
							}, -- [7]
							{
								["enabled"] = true,
							...
							}, -- [13]
							{
								...
								["criteria"] = "buff.burnout.up & ( buff.leaping_flames.up & ! buff.essence_burst.up || ! buff.leaping_flames.up & buff.essence_burst.stack < buff.essence_burst.max_stack ) & essence < essence.max - 1",
								["action"] = "living_flame",
							}, -- [14]
							{
								["enabled"] = true,
							...
							}, -- [15]
							{
								...
								["early_chain_if"] = "evoker.use_early_chaining&(buff.dragonrage.up||essence.deficit<=1)&ticks>=2&(raid_event.movement.in>2||buff.hover.up)",
								["criteria"] = "raid_event.movement.in > 2 || buff.hover.up",
								["description"] = "Early Chain in DR or if overflowing chain after the 3rd damage tick. Clip after third tick in dragonrage for more important buttons. Will only cast if >2s till movement",
							}, -- [16]
							{
								["enabled"] = true,
						...
						["fb"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.font_of_magic.enabled || ( debuff.in_firestorm.up & talent.everburning_flame.enabled & active_enemies <= 3 ) || ( buff.dragonrage.remains <= 3.25 * spell_haste & buff.dragonrage.remains >= 2.5 * spell_haste )",
								["action"] = "fire_breath",
								["empower_to"] = 3,
							}, -- [3]
							{
