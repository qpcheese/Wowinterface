...
IPMTDungeon = {
	...
	["affixes"] = {
		{
			["id"] = 6,
			["text"] = "Non-boss enemies enrage at 30% health remaining, temporarily granting immunity to crowd control effects.",
			["name"] = "Raging",
		}, -- [1]
		{
			["id"] = 124,
			["text"] = "While in combat, enemies periodically summon damaging whirlwinds.",
			["name"] = "Storming",
		}, -- [2]
		{
			["id"] = 9,
