...
Rematch5Settings = {
	...
	["LastToastedPetID"] = "BattlePet-0-000013019B3B",
	["FavoriteFilters"] = {
	},
	...
	["Filters"] = {
		...
		["RawSearchText"] = "Rebuilt Mechanical Spider",
		["Similar"] = {
		},
		["Search"] = {
			["Pattern"] = "[rR][eE][bB][uU][iI][lL][tT] [mM][eE][cC][hH][aA][nN][iI][cC][aA][lL] [sS][pP][iI][dD][eE][rR]",
			["Length"] = 25,
		},
		["Breed"] = {
		},
